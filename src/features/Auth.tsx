      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12">
        ...
        <div className="w-full max-w-sm space-y-4">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-4 px-6 bg-foreground text-background rounded-2xl font-medium transition-smooth hover:scale-[1.02] disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-4 px-6 glass-card rounded-2xl font-medium transition-smooth hover:scale-[1.02] disabled:opacity-50"
          >
            <span className="text-xl">🔍</span>
